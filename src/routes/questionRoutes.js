...
router.get('/questions', authMiddleware, authorizeRoles('admin', 'teacher'), questionController.getQuestions);
router.get('/filtered-questions/:classNo/:language', authMiddleware, questionController.getFilteredQuestions);
