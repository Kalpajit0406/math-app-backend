...
router.post('/scan', authMiddleware, authorizeRoles('admin', 'teacher'), secureDiskUpload.single('image'), ocrController.scanImage);
router.post('/process', authMiddleware, authorizeRoles('admin', 'teacher'), secureDiskUpload.single('image'), ocrController.scanImage);
